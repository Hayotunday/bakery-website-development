...
export default function BrandSection() {
  return (
    <section
      id="story"
      className="py-24 px-6 md:px-12 max-w-6xl mx-auto overflow-hidden"
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-8">
          ...
          <p className="text-lg text-primary/70 leading-relaxed">
            At Perfect White, we believe that every event deserves a
            center-piece that is as stunning as it is delicious. Our cakes are
            created using premium ingredients, focusing on clean aesthetics and
            ...
            <div className="flex items-start gap-4 p-5 rounded-2xl bg-primary/5 border border-primary/10">
              ...
              <div>
                ...
                <p className="text-sm text-primary/60">
                  Only the finest organic flours and artisanal chocolates.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-4 p-5 rounded-2xl bg-primary/5 border border-primary/10">
              ...
              <div>
                ...
                <p className="text-sm text-primary/60">
                  Tailored event planning and cake design for your unique
                  vision.
                </p>
              </div>
            </div>
